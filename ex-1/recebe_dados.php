...
<body>
    ...
    if ($num1 < 0) { ?>
        <div class='form'>
            <div>
                <h2>O número <?= $num1 ?> é um valor negativo!</h2>
            </div>
            <div class="error">
                <a href="./index.php">
    ...
    <?php } elseif ($num1 === '0') { ?>
        <div class='form'>
            <div>
                <h2>O número <?= $num1 ?> é igual a 0!</h2>
            </div>
            <div class="error">
                <a href="./index.php">
                    <svg width="17px" height="17px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-arrow-backward">
    ...
    <?php } elseif($num1 > 0) { ?>
        <div class='form'>
            <div>
                <h2>O número <?= $num1 ?> é um valor positivo!</h2>
            </div>
            <div class="error">
                <a href="./index.php">
                    <svg width="17px" height="17px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-arrow-backward">
    ...
    <?php } else { ?>
        <div class="form">
            <h2>Erro, o formulário não pode estar vazio! Por favor, preencha-o e tente novamente.</h2>
        </div>
